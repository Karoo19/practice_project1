...
public class DummyTicketBooking {// User defined method to select Date from Date Pickers
	...
	public static void main(String[] args) throws InterruptedException {
		...
		selectDate(driver, depDateDatePicker, "30","Oct","2023"); //Departure date  DD/MM/YYYY
		
		WebElement returnDateDatePicker=driver.findElement(By.xpath("//input[@id='returndate']"));
		selectDate(driver, returnDateDatePicker, "15","Nov","2023"); //return date  DD/MM/YYYY//Delivery options:
